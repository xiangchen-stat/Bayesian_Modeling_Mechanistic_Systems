...
library(here)
source(here("vignettes", "calibration", "init_lib.r"))
seed <- 1234
set.seed(seed)
path <- "Dan_pde_nopermute_train_6x6_26_50_1"
...
# Dan_pde_nopermute_train_6x6_6_25_4
# Dan_pde_nopermute_train_20x20_6_25_1
# Dan_pde_nopermute_train_6x6_30_75_1
