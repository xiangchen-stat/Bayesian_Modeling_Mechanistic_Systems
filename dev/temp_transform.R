####
# 2024.6.28
# try to manipulate data ahead to avoid changign algorithm
# fail due to F_ls too large
{
...
## FFBS----
Sys.time()
res_ffbs <- FFBS(nsam = nsam, Y = Y, F_ls = F_ls, G_ls = G_ls,
                      W_ls = W_ls, V_ls = V_ls,
                      m0 = m0, M0 = M0,
                      n0 = n0, D0 = D0,
                      nT = nT, delta = 1.0)
