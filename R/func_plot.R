...
plot_panel_heatmap_9 <- function(dat, input_num, tstamp, max_y, Nx, Ny, nT, filename = "plot_panel_"){
  plot_ls <- list()
  ...
  ggsave(filename = paste(filename, as.numeric(Sys.time()), ".png", sep = ""),
         path = path_fig,
...
# calibration ----
# plot heatmap as a 3x3 panel
plot_panel_heatmap_9_cal <- function(dat, tstamp, max_y, loc_cal, Nx, Ny, filename = "plot_panel_"){
  plot_ls <- list()
  ind_plot <- 1 # start counting
...
plot_panel_heatmap_9_cal_nolab <- function(dat, tstamp, min_y = 0, max_y, loc_cal, Nx, Ny, filename = "plot_panel_"){
  plot_ls <- list()
  ind_plot <- 1 # start counting
